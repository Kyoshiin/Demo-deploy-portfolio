...
const Skill = ({ name, x, y }) => {
  return (
    <motion.div
      ...
      initial={{ x: 0, y: 0 }}
      whileInView={{ x: x, y: y, transition: { duration: 1.5 } }} // to trigger on viewing
      viewport={{ once: true }}
    >
      {name}
    </motion.div>
...
const Skills = () => {
  return (
    <>
      ...
      >
        {/* ref: https://developer.mozilla.org/en-US/docs/Web/CSS/gradient/repeating-radial-gradient */}
        <motion.div
        ...
        <Skill name="Android" x="20vw" y="6vw" />
        <Skill name="Java" x="0vw" y="12vw" />
        <Skill name="Web" x="-20vw" y="-15vw" />
        <Skill name="React" x="32vw" y="-10vw" />
        <Skill name="Angular" x="15vw" y="-15vw" />
      </div>
    </>
  );
};
